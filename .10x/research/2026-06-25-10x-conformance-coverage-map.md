...
- `autoresearch/candidates`: 42 promoted, 63 discarded, 4 discarded-null, 1
  cancelled.
- `.10x/research`: 252 done, 12 active, 1 open.
- `.10x/evidence`: 261 recorded.
- `.10x/reviews`: 179 recorded.
