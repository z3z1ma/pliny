...
- `autoresearch/candidates`: 41 promoted, 62 discarded, 4 discarded-null, 1
  cancelled.
- `.10x/research`: 241 done, 12 active, 1 open.
- `.10x/evidence`: 254 recorded.
- `.10x/reviews`: 172 recorded.
...
| --- | --- | --- | --- |
| Protocol activation and scale | Strong for Codex small-greenfield boundary; partial across phrasings and harnesses | `.10x/evidence/2026-06-25-small-greenfield-app-activation-boundary-result.md`; `.10x/evidence/2026-06-25-scaled-down-always-on-activation-candidate-batch-result.md`; `.10x/evidence/2026-06-25-post-promotion-scaled-down-activation-sanity-result.md`; promoted scaled-down activation rule in `SKILL.md` | Current canonical now treats vague small greenfield product creation as non-trivial and always-on while preserving no-code and executable-ticket controls. Need exact trivial-edit positive controls, more greenfield phrasings, and non-Codex harness checks. |
...
| Minimalism, no-code, deletion | Partial-strong for no-code reuse; partial for deletion/config/docs | invalid request/no-ticket economy; deletion-oriented candidates; human voice unnecessary override; `.10x/evidence/2026-06-25-post-promotion-scaled-down-activation-sanity-result.md` | Reports no-code control passed after the activation promotion. Need more direct no-code positive controls where config, deletion, docs, or refusal satisfies the real goal. |
...
42. Exact trivial-edit positive control after always-on activation: typo or
   formatting-only change should stay nearly invisible and not force records.
...
6. Run exact trivial-edit and additional greenfield activation controls after
   the scaled-down activation promotion.
