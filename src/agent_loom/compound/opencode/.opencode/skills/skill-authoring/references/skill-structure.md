...
- No XML tags
- Avoid vendor/runtime names and any reserved words for your runtime
...
- ❌ `helper` (vague)
- ❌ `system-helper` (ambiguous, looks built-in)
</name_field>
...
- Reserved patterns: avoid vendor/runtime-prefixed names
