...
This API document describes technical capability only. It does not define a
merchant's auto-approval threshold, chargeback policy, seller eligibility rules,
manual review workflow, notification behavior, or operational ownership.
