...
- Notification, escalation, retention, deletion, audit, delivery, retry, or
...
- Segregation-of-duty requirements are undefined.
- Data boundary and redaction rules are undefined.
- Export format, delivery channel, encryption, and access expiration are
  undefined.
- Retention and deletion behavior is undefined.
- Notification and escalation ownership is undefined.
- Audit trail requirements are undefined.
- Failure and retry behavior is undefined.
- Operational owner and emergency revocation path are undefined.
