...
- 2026-06-23: Recorded evidence exists for column order, hidden-row exclusion,
  escaping commas, quotes, and newlines, and existing `formatVisibleRows`
  behavior.
- 2026-06-23: Review passed for visible rows CSV export scope.
- 2026-06-23: Child noted that the legacy nightly export path still lacks
  quote/newline coverage. That path is explicitly outside this ticket's scope
  and has no durable follow-up owner yet.

## Blockers

- None for visible rows CSV export scope.
